...
const metrics = [
  { 
    ...
    suffix: "", 
    prefix: "",
    label: "Queries processed today",
    sublabel: "by Aevon beta users",
  },
  { 
    value: 99, 
    suffix: ".99%", 
    ...
    sublabel: "across all Indian regions",
  },
  { 
    value: 48, 
    suffix: "ms", 
    ...
    <section ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span>Aevon by FilmU & Fykko</span>
          <span>Hindi · Tamil · Telugu · Bengali</span>
          <span>Kannada · Marathi · Gujarati</span>
          <span className="text-foreground">+15 more Indian languages</span>
        </div>
      </div>
    </section>
  );
