...
const words = ["think", "reason", "create", "innovate"];
        ...
        <div className="lg:max-w-[60%]">
          ...
          >
            <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
              ...
              Aevon by FilmU & Fykko — India&apos;s Own AI
            </span>
          </div>
          ...
          <div className="mb-12">
            ...
            >
              <span className="block whitespace-nowrap">India&apos;s Own.</span>
          ...
          <p className={`text-lg text-white/60 max-w-xl leading-relaxed transition-all duration-1000 delay-200 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}>
            Aevon is a large language model built in India, for India and the world — by FilmU and Fykko. Multilingual, multimodal, API-first.
          </p>
        </div>
      </div>
