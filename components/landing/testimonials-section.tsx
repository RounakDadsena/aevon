...
const testimonials = [
  {
    quote: "Aevon's Hindi understanding is genuinely impressive. It's the first model that doesn't feel like a translation — it reasons natively in Hindi.",
    author: "Priya Sharma",
    role: "CTO",
    company: "Kirana Tech",
    metric: { value: "3x", label: "faster dev cycles" },
  },
  {
    quote: "We switched from GPT-4 to Aevon for our Tamil customer support bot. Accuracy jumped significantly and latency halved.",
    author: "Arun Kumar",
    role: "AI Lead",
    company: "Namma Ops",
    metric: { value: "2x", label: "accuracy improvement" },
  },
  {
    quote: "Finally an LLM that understands the Indian context — slang, cultural references, code-switching. Aevon just gets it.",
    author: "Ritika Menon",
    role: "Founder",
    company: "BharatAI Labs",
    metric: { value: "22+", label: "languages supported" },
  },
  {
    quote: "The API is clean, the docs are excellent, and the latency from India is unmatched. Aevon is what the ecosystem needed.",
    author: "Siddharth Rao",
    role: "Engineer",
    company: "DeepBuild",
    metric: { value: "<50ms", label: "avg API latency" },
  },
];
