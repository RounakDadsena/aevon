...
const securityFeatures = [
  {
    ...
    description: "Your prompts, completions, and model weights stay completely private.",
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Aevon never trains on your data. Bank-grade encryption protects every request, response, and fine-tuned model.
            </p>
          </div>
        </div>
