...
const steps = [
  {
    ...
    description: "Request API access for Aevon. Early partners get priority onboarding, generous free-tier credits, and direct support from the FilmU & Fykko team.",
    code: `// Aevon by FilmU & Fykko
const aevon = new AevonClient({
  apiKey: process.env.AEVON_API_KEY,
  region: 'in-west-1', // India-hosted
});`,
  },
  {
    number: "02",
    title: "Integrate",
    subtitle: "via API",
    description: "Drop Aevon into your product using our REST API or SDKs. Supports streaming, function calling, embeddings, and multimodal inputs out of the box.",
    code: `const response = await aevon.chat({
  model: 'aevon-pro',
  messages: [
    { role: 'user', content: prompt }
  ],
  language: 'hi', // Hindi, Tamil, etc.
  stream: true,
});`,
  },
  {
    ...
    title: "Deploy",
    subtitle: "& scale",
    description: "Go from prototype to production in hours. Aevon's infrastructure scales automatically — from a single API call to millions, all within India.",
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Integrate.</span>
        ...
        <div className="grid lg:grid-cols-3 gap-4">
          {steps.map((step, index) => (
            ...
            >
              ...
              <p className={`text-white/60 leading-relaxed mb-6 transition-opacity duration-300 ${
              ...
              {/* Code snippet */}
              <pre className={`text-xs font-mono text-white/40 bg-white/5 p-4 rounded overflow-x-auto transition-opacity duration-300 ${
